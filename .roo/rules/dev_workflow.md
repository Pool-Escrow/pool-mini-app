...
2.  **`task-master` CLI (For Users & Fallback)**:
    ...
    - Install globally with `bun add -g task-master-ai` or use locally via `bunx task-master-ai ...`.
...
9.  **Commit Changes (If using Git):**
    ...
    - Consider if a Changeset is needed according to [`changeset.md`](mdc:.roo/rules/changeset.md). If so, run `bun changeset`, stage the generated file, and amend the commit or create a new one.
